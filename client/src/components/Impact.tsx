...
const Impact = () => {
  ...
  const testimonials = [
    ...
    {
      quote:
        "The mentorship and community I found here gave me the confidence to apply for a summer internship at a tech startup. I got it!",
      name: "Aisha T.",
    ...
    {
      quote:
        "I never thought I could be an entrepreneur until CTC showed me that business isn't just for certain types of people. Now I'm launching my own sustainable fashion line.",
      name: "Jennifer L.",
  ...
  return (
    <section id="impact" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div
          className="absolute bottom-20 right-1/4 w-48 h-48 bg-mint-400 rounded-full blur-3xl animate-bounce"
          style={{ animationDuration: "6s" }}
        ></div>
        <div
          className="absolute top-1/2 right-10 w-24 h-24 bg-soft-400 rounded-full blur-xl animate-pulse"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-sage-700 max-w-4xl mx-auto leading-relaxed">
            Measuring success through increased confidence, creative output, and
            systemic awareness among the girls we serve.
          </p>
        </div>
          ...
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`absolute -top-2 -right-2 w-8 h-8 ${colorClasses.accent} rounded-full opacity-20 group-hover:scale-150 transition-all duration-500`}
                ></div>

                <div
                  className={`bg-gradient-to-br ${colorClasses.icon} rounded-2xl p-4 w-20 h-20 mx-auto mb-6 group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 shadow-lg`}
                >
              ...
              {testimonials.map((testimonial, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`w-4 h-4 ${colorClasses.accent} rounded-full mb-6 group-hover:scale-150 transition-transform duration-300`}
                    ></div>
        ...
        <div className="text-center mt-20">
          <div className="relative bg-gradient-to-r from-sage-600 via-mint-600 to-sage-600 rounded-3xl p-12 text-white shadow-2xl overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-10">
              ...
              <div
                className="absolute bottom-4 right-4 w-12 h-12 bg-white rounded-full animate-bounce"
                style={{ animationDelay: "1s" }}
              ></div>
              <div
                className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-20 h-20 bg-white rounded-full animate-pulse"
