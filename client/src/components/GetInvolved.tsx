...
const GetInvolved = () => {
  const opportunities = [
    {
      ...
      description: "Apply for our Creation Circles, contribute to our Digital Zine, or be featured on our podcast",
      action: "Apply Now",
      color: "sage",
    ...
    },
    {
      ...
      description: "Guide younger girls through their creative journey and share your expertise",
      action: "Mentor Application",
      color: "mint",
    ...
    },
    {
      ...
      description: "Join our core team of ~15 student leaders helping run programs and create content",
      action: "Leadership Application",
      color: "soft",
      eligibility: "High School & College Students"
    },
    {
      ...
      description: "Support our mission through skill-based volunteering, event support, or advisory roles",
    ...
    },
    {
      ...
      description: "Help us provide free programming and resources to girls from all backgrounds",
      action: "Donate",
      color: "mint",
    ...
    },
    {
      ...
      description: "Share our content, recommend girls for programs, or connect us with potential partners",
      action: "Share & Connect",
      color: "soft",
  ...
  return (
    <section id="get-involved" className="py-20 bg-gradient-to-br from-cream-200 to-sage-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-sage-700 max-w-3xl mx-auto">
            There are many ways to join our community and support our mission of empowering girls through creation.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {opportunities.map((opportunity, index) => {
            ...
            return (
              ...
              >
                <div className={`${colorClasses.bg} rounded-lg p-3 w-16 h-16 flex items-center justify-center mb-4`}>
                ...
                <Button 
                  className={`w-full text-white ${colorClasses.button}`}
                >
                  {opportunity.action}
                </Button>
              </div>
        ...
        <div className="bg-white rounded-xl p-8 border border-sage-200">
          <div className="text-center mb-8">
            ...
            <p className="text-sage-700 max-w-3xl mx-auto">
              We're always looking for organizations that share our values and want to expand opportunities for girls in creation and leadership.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-sage-600">She's the First, Girls Who Code, Technovation Girls</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-sage-600">Teachers, counselors, and administrators</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-sage-600">Local government and school boards</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-sage-600">Sponsorships and skill-based volunteering</p>
            </div>
          </div>
