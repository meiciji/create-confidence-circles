...
import { Quote, TrendingUp, Users2, Lightbulb, Heart, Target } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center bg-sage-100 rounded-full px-6 py-2 mb-6">
            ...
            <span className="text-sage-800 text-sm font-medium">The Challenge</span>
          </div>
          
          <h2 className="text-3xl sm:text-5xl font-bold text-sage-900 mb-8 animate-fade-in">
            The Challenge We're <span className="text-transparent bg-clip-text bg-gradient-to-r from-sage-600 to-mint-600">Addressing</span>
          </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div className="group">
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-500 border-l-4 border-sage-500">
                  ...
                  <div className="text-4xl font-bold text-sage-900 mb-3 group-hover:text-sage-700 transition-colors">10%</div>
                  <p className="text-sage-700 font-medium">of Fortune 500 CEOs are women</p>
                </div>
              </div>
              
              <div className="group">
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-500 border-l-4 border-mint-500" style={{ transitionDelay: '0.1s' }}>
                  ...
                  <div className="text-4xl font-bold text-mint-900 mb-3 group-hover:text-mint-700 transition-colors">&lt;2%</div>
                  <p className="text-mint-700 font-medium">of VC funding goes to women-led startups</p>
                </div>
              </div>
              
              <div className="group">
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-500 border-l-4 border-soft-500" style={{ transitionDelay: '0.2s' }}>
                  ...
                  <div className="text-4xl font-bold text-soft-900 mb-3 group-hover:text-soft-700 transition-colors">Gap</div>
                  <p className="text-soft-700 font-medium">Even in female-driven industries, leadership remains male-dominated</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative bg-gradient-to-r from-sage-50 via-white to-mint-50 rounded-[3rem] p-12 lg:p-16 shadow-2xl">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center bg-white rounded-full px-6 py-3 mb-8 shadow-lg">
                ...
                <span className="text-sage-800 font-medium">Our Origin Story</span>
              </div>
              
              <h3 className="text-3xl sm:text-4xl font-bold text-sage-900 mb-8 leading-tight">
                From <span className="text-transparent bg-clip-text bg-gradient-to-r from-sage-600 to-mint-600">Discovery</span> to <span className="text-transparent bg-clip-text bg-gradient-to-r from-mint-600 to-soft-600">Empowerment</span>
              </h3>
              
              <div className="space-y-6 text-lg text-sage-800 leading-relaxed">
                <p className="bg-white/80 rounded-2xl p-6 shadow-md">
                  After discovering her voice through social media creation, <span className="font-bold text-sage-900">Mei Ying</span> founded <span className="font-bold text-sage-900">Confidence Through Creation</span> to help girls—especially those from underrepresented or underserved communities—build self-worth and leadership through digital creation.
                </p>
                <p className="bg-white/80 rounded-2xl p-6 shadow-md">
                  Whether through <span className="font-semibold text-sage-700">tech</span>, <span className="font-semibold text-mint-700">art</span>, <span className="font-semibold text-soft-700">business</span>, or <span className="font-semibold text-sage-700">media</span>, CTC helps young creators turn ideas into real-world impact and connects that process to access, equity, and systemic change.
                </p>
              </div>
            </div>
          </div>
