...
import { Play, Pause, Calendar, Clock, Download, Share2, Mic, Headphones, Users } from 'lucide-react';
...
const Podcast = () => {
  ...
  const episodes = [
    {
      ...
      description: "A powerful conversation with three young women who started their own tech companies before turning 20. We explore their journeys, challenges, and advice for the next generation.",
      host: "Sarah Chen",
    ...
    },
    {
      ...
      description: "Follow Aisha's incredible story of building and launching her environmental app that now has over 10,000 downloads. Learn about the technical challenges and business lessons.",
      host: "Maria Santos",
      guest: "Aisha Johnson",
      duration: "35 min",
    ...
    },
    {
      ...
      description: "Our youngest guests yet discuss their research on AI bias and how they're working to make artificial intelligence more inclusive and representative.",
    ...
    },
    {
      ...
      description: "How our program alumni are creating coding clubs and tech meetups in their communities, spreading digital literacy and confidence to other girls.",
      host: "Sarah Chen",
    ...
    },
    {
      ...
      description: "An honest discussion about self-doubt, confidence building, and the strategies that help young women thrive in technical environments.",
      host: "Dr. Jennifer Liu",
    ...
    {
      id: 6,
      title: "Parents as Allies: Supporting Girls in Tech",
      description: "A special episode for parents and guardians on how to encourage, support, and advocate for girls interested in technology careers.",
      host: "Maria Santos",
      guest: "Parent Panel",
      duration: "33 min",
  ...
  const categories = ["All", "Leadership", "Success Stories", "Tech Talk", "Community", "Mental Health", "Family"];
  const hosts = [
    {
      name: "Sarah Chen",
      role: "Program Director",
      bio: "Former software engineer at Google, passionate about diversity in tech"
    },
    {
      name: "Maria Santos",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cream-300 to-sage-100">
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="animate-fade-in">
            <div className="inline-flex items-center bg-white/80 backdrop-blur-sm rounded-full px-6 py-3 mb-6 shadow-lg border border-sage-200">
              ...
              <span className="text-sage-800 text-sm font-medium">Stories that inspire change</span>
            </div>
            
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-sage-900 mb-6">
              Confidence <span className="text-transparent bg-clip-text bg-gradient-to-r from-sage-600 to-mint-600">Conversations</span>
            </h1>
            
            <p className="text-xl text-sage-700 mb-8 max-w-3xl mx-auto">
              Our podcast features inspiring conversations with young women breaking barriers in technology, 
              sharing their journeys, challenges, and victories in creating a more inclusive digital world.
            </p>
      ...
      <section className="pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <Card className="bg-white/90 backdrop-blur-sm border-sage-200 text-center">
              <CardContent className="p-6">
                <div className="text-2xl font-bold text-sage-900 mb-1">50k+</div>
                <div className="text-sage-600 text-sm">Monthly Listeners</div>
              </CardContent>
            </Card>
            <Card className="bg-white/90 backdrop-blur-sm border-sage-200 text-center">
              <CardContent className="p-6">
                <div className="text-2xl font-bold text-sage-900 mb-1">100+</div>
                <div className="text-sage-600 text-sm">Featured Guests</div>
              </CardContent>
            </Card>
            <Card className="bg-white/90 backdrop-blur-sm border-sage-200 text-center">
              <CardContent className="p-6">
                <div className="text-2xl font-bold text-sage-900 mb-1">4.8★</div>
        ...
        <section key={episode.id} className="pb-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8">
              <Badge className="bg-mint-100 text-mint-800 border-mint-300 mb-4">Featured Episode</Badge>
              <h2 className="text-2xl font-bold text-sage-900">Latest Episode</h2>
            </div>
              ...
              <CardContent className="p-8">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                  <div className="lg:col-span-2">
                    ...
                    <h3 className="text-2xl font-bold text-sage-900 mb-3">{episode.title}</h3>
                    <p className="text-sage-600 mb-4">{episode.description}</p>
                  ...
                  <div className="bg-gradient-to-br from-sage-300 to-mint-300 rounded-lg h-64 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <div className="text-sage-700 font-semibold">Episode {episode.id}</div>
                      <div className="text-sage-600 text-sm">{episode.plays} plays</div>
                    </div>
                  </div>
                </div>
              </CardContent>
      ...
      <section className="pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-sage-900 mb-8 text-center">All Episodes</h2>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-2">
                        <Badge variant="outline" className="border-sage-300 text-sage-700 text-xs">
                          {episode.category}
                        </Badge>
                      ...
                      <h3 className="text-lg font-bold text-sage-900 mb-2 line-clamp-2">{episode.title}</h3>
                      <p className="text-sage-600 text-sm mb-3 line-clamp-2">{episode.description}</p>
                      
                      <div className="text-xs text-sage-500 mb-3">
                        <div><strong>Host:</strong> {episode.host}</div>
                        <div><strong>Guest:</strong> {episode.guest}</div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button size="sm" variant="outline" className="border-sage-300 text-sage-700 text-xs px-3 py-1">
      ...
      <section className="pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-sage-900 mb-8 text-center">Meet Our Hosts</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {hosts.map((host, index) => (
              <Card key={index} className="bg-white/90 backdrop-blur-sm border-sage-200 text-center">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-sage-900 mb-2">{host.name}</h3>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <Card className="bg-white/90 backdrop-blur-sm border-sage-200 shadow-xl">
            <CardContent className="p-12">
              ...
              <h2 className="text-3xl font-bold text-sage-900 mb-4">Never Miss an Episode</h2>
              <p className="text-lg text-sage-700 mb-8">
                Subscribe to Confidence Conversations and get notified when new episodes drop. 
                Join thousands of listeners who are inspired by stories of young women changing the world through technology.
              </p>
