...
const Blog = () => {
  const blogPosts = [
    {
      ...
      excerpt: "Reflecting on the incredible growth and achievements of our participants over the past year, and the impact of hands-on learning in technology education.",
    ...
    },
    {
      ...
      excerpt: "How our innovative approach to teaching programming through art and storytelling is helping girls discover their potential in technology.",
    ...
    },
    {
      ...
      excerpt: "Announcing new collaborations with local schools and organizations to bring our programs to more underrepresented communities.",
    ...
    },
    {
      ...
      excerpt: "Why having role models and mentors is crucial for young women entering STEM fields, and how our mentorship program is making a difference.",
    ...
    },
    {
      ...
      excerpt: "A recap of our recent student showcase, featuring incredible projects from web applications to digital art installations created by our participants.",
      author: "Sarah Johnson",
    ...
    },
    {
      ...
      excerpt: "Exploring the systemic challenges that keep young women out of tech careers and how grassroots education programs can create lasting change.",
      author: "Maria Rodriguez",
  ...
  const categories = ["All", "Impact Stories", "Education", "Community", "Mentorship", "Events", "Research"];
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="animate-fade-in">
            <div className="inline-flex items-center bg-white/80 backdrop-blur-sm rounded-full px-6 py-3 mb-6 shadow-lg border border-sage-200">
              ...
              <span className="text-sage-800 text-sm font-medium">Stories, insights, and updates</span>
            </div>
            
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-sage-900 mb-6">
              Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-sage-600 to-mint-600">Blog</span>
            </h1>
            
            <p className="text-xl text-sage-700 mb-8 max-w-3xl mx-auto">
              Stay updated with our latest news, success stories, and insights from the world of youth empowerment and technology education.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <Card className="bg-white/90 backdrop-blur-sm border-sage-200 shadow-xl">
            <CardContent className="p-12">
              ...
              <h2 className="text-3xl font-bold text-sage-900 mb-4">Stay Connected</h2>
              <p className="text-lg text-sage-700 mb-8">
                Subscribe to our newsletter to receive the latest updates, success stories, and program announcements.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <input
                  type="email"
                  placeholder="Enter your email address"
                  className="flex-1 px-4 py-3 border border-sage-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-sage-500 focus:border-transparent"
                />
